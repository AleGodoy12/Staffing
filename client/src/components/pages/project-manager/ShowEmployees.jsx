	...
	return (
		<>
          ...
          <section className='all-employees-info'>
            ...
            <div>
              <button onClick={change} value={0}>Empleados</button>
              <button onClick={change} value={1}>Empleados con y sin asignacion</button>
              <button onClick={change} value={2}>Empleados sin asignacion</button>
            </div>
            <section>
              {
                changeButton === 0 ? ('cero') : changeButton === 1 ? ('uno') : changeButton === 2 ? ('dos') : ('')
              }
            </section>
          </section>
        </section>
