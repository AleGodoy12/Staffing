				...
				<section className="section-right">
					...
					<section className="create-user-section">
						...
						<select onChange={onChangeSelect}>
							...
							{pm.map((e) => (
								<option key={e.id_employee} value={e.id_employee}>
									{e.name} {e.lastname}
								</option>
							))}
						</select>
						...
						<form onSubmit={createUser}>
							<input name="idUser" type="number" disabled value={user.idUser} />
							...
							<input name="email" type="text" disabled value={user.email} />

							<label htmlFor="">Rol del usuario</label>
							<input name="role" type="text" disabled value={user.role} />
